...
export default function AdminUsersIndex({ users, filters, roles }) {
    ...
    return (
        <AdminLayout currentRoute="Users Management">
                            ...
                            {users.data.map((user) => (
                                <tr key={user.id} className="hover:bg-slate-700/50 transition">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-900 text-blue-300 capitalize">
                                            {user.role}
                                        </span>
                                    </td>
